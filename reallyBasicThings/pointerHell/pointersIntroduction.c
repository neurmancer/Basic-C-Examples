#include <stdio.h>
/*
    Welcome to Inferno! Where I,Virgil, will guide you new Dantes through each ring one by one
*/
...
int main(void)
{
    ...
    int a = 13;                  //This is an int variable 
    ...
    */
    ...
    //Notice how every execution the printed address will differ(thx to ASLR) but wil be same for both &a and p
